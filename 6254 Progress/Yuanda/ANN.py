...
#            ftrain = ftrain.split('.')[0]
            ...
            coord = scaler2.fit_transform(coord)
            ...
            for test_ind in range(1,6):
                ...
                if data_type_ind == 1:
                    ...
                    coord2 = coord2
                original_coord2 = np.copy(coord2)
                ...
                e,m,s,r = calcStats(original_coord2, Y_inverse_norm,isPrint=True)
